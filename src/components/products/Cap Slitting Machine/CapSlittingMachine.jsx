...
const CapSlittingMachine = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet>
        <title>
          Cap Slitting Machine Manufacturer In Daskroi, Ahmedabad - Gujarat - TM
          TECH MAKE
        </title>
        <meta
          name="description"
          content="Leading Cap Slitting Machine manufacturer in Daskroi, Ahmedabad – TMTeckMak offers high-speed, durable machines for precise plastic cap slitting. Trusted quality, made in India."
        />
        <link
          rel="canonical"
          href="https://tmteckmake.com/cap-slitting-machine"
        />
      </Helmet>
